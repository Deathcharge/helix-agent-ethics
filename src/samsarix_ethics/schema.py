...
def get_tool_catalog_schema() -> dict[str, Any]:
    """Return a fresh copy of the tool-catalog version 1 JSON Schema."""

    return _load_schema("tool-catalog-v1.schema.json")
...
def get_policy_shadow_schema() -> dict[str, Any]:
    """Return a fresh copy of the policy shadow evaluation schema v1."""
...
def get_policy_runtime_status_schema() -> dict[str, Any]:
    """Return a fresh copy of the policy-runtime status version 1 JSON Schema."""

    return _load_schema("policy-runtime-status-v1.schema.json")
